...
<div class="content-panel reveal">
    ...
    <?php if (session()->getFlashdata('pesanbalita')): ?>
        <div class="alert alert-success" role="alert">
            <?= session()->getFlashdata('pesanbalita'); ?>
        </div>
    <?php endif; ?>

    <div class="modern-form-panel">
        <form action="balita" method="post" class="modern-form">
            <?= csrf_field(); ?>
            <div class="form-grid">
            ...
            <div class="form-grid">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input" type="text" name="alamat" id="alamat">
                </div>
                <div class="field-group">
                    <label class="field-label" for="no_telepon">Nomor Telepon</label>
                    <input class="field-input" type="text" name="no_telepon" id="no_telepon">
                </div>
                <div class="field-group">
                    <label class="field-label" for="bb">Berat Badan</label>
                    <input class="field-input" type="text" name="bb" id="bb">
                </div>
                <div class="field-group">
                    <label class="field-label" for="tb">Tinggi Badan</label>
                    <input class="field-input" type="text" name="tb" id="tb">
                </div>
                <div class="field-group">
                    <label class="field-label" for="anak_ke">Anak Ke</label>
                    <input class="field-input" type="text" name="anak_ke" id="anak_ke">
                </div>
                <div class="field-group" style="grid-column: 1 / -1;">
                    <label class="field-label" for="catatan_imunisasi">Catatan Imunisasi</label>
                    <textarea class="field-input" name="catatan_imunisasi" id="catatan_imunisasi" rows="4"></textarea>
                </div>
                <div class="field-group">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var TTLInput = document.getElementById('tgl_lahir');
        ...
        if (idgeneralselect) {
            idgeneralselect.addEventListener('change', function() {
                ...
                fetch('/getRekamMedis_ba/' + idgeneral)
