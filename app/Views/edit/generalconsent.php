...
<div class="content-panel reveal">
    ...
    <div class="modern-form-panel">
        <form action="<?= site_url('egeneral/' . $gen['id_general_consent']) ?>" method="post" enctype="multipart/form-data" class="modern-form">
            <?= csrf_field(); ?>
            <div class="form-grid">
                <div class="field-group">
                    <label class="field-label" for="nomor_rekam_medis">Nomor Rekam Medis</label>
                    <input class="field-input" type="text" id="nomor_rekam_medis" name="nomor_rekam_medis" value="<?= $gen['nomor_rekam_medis_gc'] ?>">
                </div>
                <div class="field-group">
                    <label class="field-label" for="nik">NIK</label>
                    <input class="field-input" type="text" id="nik" name="nik" value="<?= $gen['nik'] ?>">
                </div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input" type="text" id="nama_pasien" name="nama_pasien" value="<?= $gen['nama_pasien'] ?>">
                </div>
                <div class="field-group">
                    <label class="field-label" for="tanggal_lahir">Tanggal Lahir</label>
                    <input class="field-input" type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?= $gen['tanggal_lahir'] ?>">
                </div>
                <div class="field-group">
                    <label class="field-label" for="alamat_pasien">Alamat Pasien</label>
                    <input class="field-input" type="text" id="alamat_pasien" name="alamat_pasien" value="<?= $gen['alamat_pasien'] ?>">
                </div>
                <div class="field-group">
                    <label class="field-label" for="no_hp_pasien">No HP Pasien</label>
                    <input class="field-input" type="text" id="no_hp_pasien" name="no_hp_pasien" value="<?= $gen['no_hp_pasien'] ?>">
                </div>
                <div class="field-group">
                    <label class="field-label" for="nama_wali">Nama Wali</label>
                    <input class="field-input" type="text" id="nama_wali" name="nama_wali" value="<?= $gen['nama_wali'] ?>">
                </div>
                <div class="field-group">
                    <label class="field-label" for="tanggal_lahir_wali">Tanggal Lahir Wali</label>
                    <input class="field-input" type="date" id="tanggal_lahir_wali" name="tanggal_lahir_wali" value="<?= $gen['tanggal_lahir_wali'] ?>">
                </div>
                <div class="field-group">
                    <label class="field-label" for="alamat_wali">Alamat Wali</label>
                    <input class="field-input" type="text" id="alamat_wali" name="alamat_wali" value="<?= $gen['alamat_wali'] ?>">
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input" type="text" id="no_hp_wali" name="no_hp_wali" value="<?= $gen['no_hp_wali'] ?>">
                </div>
                <div class="field-group">
