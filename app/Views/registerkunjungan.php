...
<div class="content-panel reveal">
    ...
    <div class="modern-form-panel">
        <form action="kunjungan" method="post" class="modern-form">
            <?= csrf_field(); ?>
            <div class="form-grid">
            ...
            <div class="form-grid">
                <div class="field-group">
                    ...
                    <input class="field-input" type="text" id="nama_penderita" name="nama_penderita">
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input <?= isset($validation) && $validation->hasError('Kelurahan') ? 'is-invalid' : '' ?>" type="text" id="Kelurahan" name="Kelurahan">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input <?= isset($validation) && $validation->hasError('Diagnosa') ? 'is-invalid' : '' ?>" type="text" id="Diagnosa" name="Diagnosa">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input <?= isset($validation) && $validation->hasError('Terapi_Obat') ? 'is-invalid' : '' ?>" type="text" id="Terapi_Obat" name="Terapi_Obat">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input <?= isset($validation) && $validation->hasError('tanggal_masuk') ? 'is-invalid' : '' ?>" type="date" id="tanggal_masuk" name="tanggal_masuk">
                ...
                <div class="field-group">
                    ...
                    <input class="field-input <?= isset($validation) && $validation->hasError('Jasa') ? 'is-invalid' : '' ?>" type="text" id="Jasa" name="Jasa">
                ...
                <div class="field-group" style="grid-column: 1 / -1;">
                    ...
                    <textarea class="field-input" id="Keterangan" name="Keterangan" rows="4"></textarea>
                </div>
                <div class="field-group">
                    <label class="field-label" for="petugas">Petugas Yang Bertanggung Jawab</label>
                    <input class="field-input <?= isset($validation) && $validation->hasError('petugas') ? 'is-invalid' : '' ?>" type="text" id="petugas" name="petugas">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var noRekamMedisInput = document.getElementById('nomor_rekam');
